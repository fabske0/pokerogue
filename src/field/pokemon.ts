...
export default abstract class Pokemon extends Phaser.GameObjects.Container {
  ...
  getDexAttr(): bigint {
    let ret = 0n;
    // ret |= this.gender !== Gender.FEMALE ? DexAttr.MALE : DexAttr.FEMALE; // old
    ret |= this.gender === Gender.GENDERLESS ? 0n : this.gender !== Gender.FEMALE ? DexAttr.MALE : DexAttr.FEMALE;
