...
const additonalTMs: Partial<Record<SpeciesId, MoveId[]>> = {
  [SpeciesId.BAYLEEF]: [MoveId.GRASSY_TERRAIN],
  [SpeciesId.MEGANIUM]: [MoveId.GRASSY_TERRAIN],
  [SpeciesId.CROCONAW]: [MoveId.METAL_CLAW, MoveId.FAKE_TEARS],
  [SpeciesId.FERALIGATR]: [MoveId.METAL_CLAW, MoveId.FAKE_TEARS],
  [SpeciesId.LEDIAN]: [MoveId.PSYBEAM, MoveId.SCREECH],
  [SpeciesId.ARIADOS]: [MoveId.PSYBEAM],
  [SpeciesId.LANTURN]: [MoveId.PSYBEAM],
  ...
  [SpeciesId.DONPHAN]: [MoveId.FOCUS_ENERGY],
  [SpeciesId.HITMONTOP]: [MoveId.ALLY_SWITCH],
};
